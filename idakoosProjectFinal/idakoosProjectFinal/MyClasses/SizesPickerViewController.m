...
@interface SizesPickerViewController ()

@end

@implementation SizesPickerViewController
...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        _sizeNames = [[NSMutableArray alloc] initWithArray:[root objectForKey:@"Size"]];
        ...
        NSInteger rowsCount = [_sizeNames count];
        ...
        for (NSString *sizeName in _sizeNames) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [_sizeNames objectAtIndex:indexPath.row];
...
{
    if (_delegate != nil) {
        [_delegate selectedSize:indexPath.row];
    }
}
